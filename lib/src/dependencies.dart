...
abstract class FeatureDependencies extends StatelessWidget {
  ...
  Registration registerParamsFactory<T, P>(T Function(BuildContext context, P params) create) {
    return ParamsFactoryRegistration<T, P>(create);
  }

  Registration registerSingleton<T>(T Function(BuildContext context) create, {void Function(BuildContext, T)? dispose}) {
     return SingletonRegistration<T>(create, dispose: dispose);
  }

  Registration registerSingletonAs<I extends T, T>(T Function(BuildContext context) create, {void Function(BuildContext, I)? dispose}) {
...
extension FeatureContextExtension<F extends FeatureDependencies> on BuildContext {
  T resolve<T>() {
    try {
  ...
  T resolveWithParams<T, P>(P params) {
    try {
      final factory = Provider.of<ParamsFactoryRegistration<T, P>>(this, listen: false);
